...
const ripples = Array.from(document.querySelectorAll('.component-section .ripple mwc-ripple:not(.customControls)'));
const customControlsRipple = document.querySelector('.component-section .ripple .customControls')
const noRippleBox = document.querySelector('.component-section .ripple .noRipple')
...
const rh = new RippleHandlers(async () => customControlsRipple);
